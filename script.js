...
function bookCard(book) {
  ...
  return `
                <a href="${
                  info?.infoLink
                }" target="_blank" class="flex items-end w-full cursor-pointer transform hover:scale-105 transition">
                    ...
                    <div class="bg-white/16 backdrop-blur-sm p-4 w-full flex flex-col justify-end h-34 rounded-tr-xl rounded-br-xl shadow-lg">
                        ...
                        <p class="text-gray-300 text-sm line-clamp-1">${info?.authors.join(
                          ", "
                        )}</p>
